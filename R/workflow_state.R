...
he_artifact_dependencies <- list(
  ...
  wq_summary = c("wq_input", "oe_result", "site_mapping"),
  joined_core = c("oe_result", "flow_statistics", "site_mapping"),
  wq_enrichment = c("joined_core", "wq_summary"),
  rhs_enrichment = c("joined_core", "rhs_input", "site_mapping"),
  joined_enriched = c("joined_core", "wq_enrichment", "rhs_enrichment"),
...
he_artifact_default_next_actions <- c(
  ...
  wq_summary = "Build the current Water-quality summary in Stage 2.",
  joined_core = "Build the Core Joined HE dataset.",
  wq_enrichment = "Add the current Water-quality summary if enrichment is selected.",
  rhs_enrichment = "Add the current River Habitat Survey data if enrichment is selected.",
