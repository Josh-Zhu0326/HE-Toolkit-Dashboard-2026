...
- `../../research/background/3.5 Workflow Optimisation Options.pdf`
...
- `../../research/background/3.1 Shiny App.pdf`
- `../../research/background/3.7 WQ_RHS assumptions and questions list.pdf`
...
- `../../research/background/3.2 New Zealand Freshwater Monitoring and Improvement.md`
...
- Existing dashboard audit: `HE-Toolkit-Dashboard-2026/docs/project/audits/existing-dashboard-audit.md`
- Testing checklist: `HE-Toolkit-Dashboard-2026/docs/testing/plans/testing-checklist.md`
- Picture evidence folder: `HE-Toolkit-Dashboard-2026/docs/testing/evidence/legacy-2026-06-20/`
...
Important results recorded in `docs/project/audits/existing-dashboard-audit.md`:
...
- `../../research/study-materials/3.3 Think-aloud plan.docx`
