...
- No repository evidence proves two real pilots. `docs/research/study-materials/pilot-execution.md` is a blank session pack/template; branch `origin/zhaohang/week09-pilot-test-results` contains a task-script test result, not two de-identified participant session packets.
...
| 10 | Valid/invalid/warning/recovery handling | Partially implemented | Guarded upload helpers, `format_validation_message()`, `run_model()`; error guidance `docs/requirements/WK8-09_Complete_Error_List.md` | Invalid local Flow/mapping/model tests passed; old ST-07E/F browser evidence is at `7cf242f`, not current | Coverage is indirect and incomplete; execute RAW-linked recovery cases at RC. |
...
|---:|---|---|---|---|
| 39 | RAW-01–25 user messages | Partially implemented | All IDs documented in `docs/requirements/5.3_Error_List.md`; later guidance in `docs/requirements/WK8-09_Complete_Error_List.md` | Guidance commit `4d7afd3` changed docs only; IDs are not traced to runtime/test IDs. Build one-to-one RTM. |
...
| 51 | Analysis plan | Evidence missing | `docs/testing/plans/experimental-design.md` is software-test design, not a formal study analysis plan | Analysis decisions could drift after data collection. |
...
| `docs/testing/reports/2026-07-10/Smoke_test_execution_2026-07-10.md` | Browser/manual smoke evidence | Existing executed record, but baseline `7cf242f`, not current |
...
| Ethics/material cross-check | Claimed but evidence missing | `docs/decisions/client-decision-log-v1.md:130` says ethics approved but requires controlled authoritative record, which is absent |
| Pilot 1 packet | Template only | `docs/research/study-materials/pilot-execution.md` blank pack |
...
- `docs/testing/reports/2026-07-10/Smoke_test_execution_2026-07-10.md`, `Functional_Test_Execution_Record.md`, `observation_log.md`.
- `docs/requirements/5.3_Error_List.md`, `docs/requirements/WK8-09_Complete_Error_List.md`, `docs/research/study-materials/pilot-execution.md`.
- `docs/decisions/client-decision-log-v1.md`, Week 7 data/dependency/modelling/RTM contracts, Week 8 UI mapping.
