...
> Supersedes: the public state vocabulary, transitions, outcome labels, and checkpoint-state rows in the [Week 7 v1 review baseline](../week07/dependency-state-matrix-v1.md)  
