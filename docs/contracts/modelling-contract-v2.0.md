...
> Authority: `DEC-39`, `DEC-45`, `DEC-46`, `DEC-47`; client email `SRC-09` in the [Client Decision Log](../decisions/client-decision-log-v1.md)
...
3. `Q95z` is the only eligible Q95 predictor for both model paths. Raw `Q95` may remain for display or provenance but must not be offered or accepted for modelling. This contract does not independently add raw `Q10`.
